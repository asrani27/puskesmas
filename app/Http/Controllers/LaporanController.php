...
class LaporanController extends Controller
{
    ...
    public function exportkunjunganpasientoday()
    {
        ...
        $data = Tpelayanan::whereDate('tanggal', '=', $today)->get()->map(function($item, $key) use ($no){
            ...
            $item->pekerjaan     = $item->pendaftaran->pasien->pekerjaan->nama;
            ...
            //dd(json_encode($item->kode_diagnosa));
            //$item->diagnosa      = $item->diagnosa->pasien->no_asuransi;
            //$item->jenis_kasus   = $item->pendaftaran->pasien->no_asuransi;
