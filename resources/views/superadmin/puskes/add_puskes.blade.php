    ...
    <div class="col-xs-12">
        <div class="widget-box">
            <div class="widget-header">
                <h4 class="widget-title">Tambah Puskesmas</h4>
            </div>

            <div class="widget-body">
                <div class="widget-main no-padding">
                    <form  class="form-horizontal" role="form" method="POST" action="/sa/puskes/add">
                        @csrf
                        <!-- <legend>Form</legend> -->
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" name="alamat" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" name="telp" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" name="kecamatan" class="form-control" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" name="kelurahan" class="form-control" required/>
                                </div>
                            </div>
                        </fieldset>
