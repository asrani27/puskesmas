...
<div class="alert alert-block alert-info">
    ...
    <i class="ace-icon fa fa-exclamation-circle blue bigger-130"></i>
    Manajemen
    <strong class="green">
        MENU
    </strong>,

    Untuk Memanajemen menu dalam aplikasi
</div>

<a href="/home" class="btn btn-danger btn-xs">
    Kembali
</a>
<a href="#modal-table" role="button" class="btn btn-primary btn-xs" data-toggle="modal"> Tambah Menu Utama</a>
<a href="/preview_menu" class="btn btn-success btn-xs">
    Preview Menu
</a>
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="dd dd-draghandle">
                    ...
                    <ol class="dd-list">
                        <li class="dd-item dd2-item dd-collapse">
                            <div class="dd-handle dd2-handle">
                                <i class="normal-icon ace-icon fa {{$item->icon}} blue bigger-130"></i>
                            </div>
                            <div class="dd2-content">{{$item->nama}}
                                <div class="pull-right action-buttons">
                                    ...
                                    <a class="red" href="/sa/menu/delete/{{$item->id}}">
                            ...
                            @foreach ($item->submenu as $sub)
                                ...
                                <li class="dd-item dd2-item" data-id="16">
                                    <div class="dd-handle dd2-handle">
                                        <i class="normal-icon ace-icon fa fa-chevron-right green bigger-130"></i>
                                    </div>
                                    <div class="dd2-content">{{$sub->nama}}
                                        <div class="pull-right action-buttons">
                                            <a href="#" role="button" class="green sub-menu" data-toggle="modal" data-id="{{$sub->id}}" data-nama="{{$sub->nama}}">
                                                <i class="ace-icon fa fa-plus bigger-130"></i>
                                            </a>
                                            <a class="blue" href="#">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>
                                            <a class="red" href="/sa/menu/delete/{{$sub->id}}">
                                                <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <ol class="dd-list">
                                        <li class="dd-item dd2-item" data-id="16">
                                            ...
                                            <div class="dd2-content">{{$sub2->nama}}
                                                <div class="pull-right action-buttons">
                                                    <a class="blue" href="#">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>
                                                    <a class="red" href="/sa/menu/delete/{{$sub2->id}}">
                                                        <i class="ace-icon fa fa-trash-o bigger-130"></i>
                                                    </a>
                                                </div>
                                            </div>   
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body no-padding">
                ...
                <form class="form-horizontal" role="form" method="POST" action="/sa/menu/add">
                    @csrf
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pilih Icon </label>
                            <div class="col-sm-9"> 
                                <select name="icon">
...
<div id="sub-modal-table" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header no-padding">
                <div class="table-header">
            ...
            <div class="modal-body no-padding">
                <div class="widget-main no-padding">
                <form class="form-horizontal" role="form" method="POST" action="/sa/submenu/add">
                    @csrf
                    <fieldset>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Top Menu </label>

                            <div class="col-sm-9">
                                <input type="text" name="menu_nama" id="menu_nama" value="" class="form-control" readonly/>
                                <input type="hidden" name="menu_id" id="menu_id" value="" class="form-control" readonly/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Menu </label>
