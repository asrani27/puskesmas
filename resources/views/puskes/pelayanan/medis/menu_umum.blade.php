<div class="row">
    ...
    <div class="col-md-8" style="padding-left:15px; padding-top:15px">
        <a href="/pelayanan/medis/proses/{{$data->id}}/umum/anamnesa" class="btn bg-gradient-primary btn-sm">Anamnesa</a>
        <a href="/pelayanan/medis/proses/{{$data->id}}/umum/diagnosa" class="btn bg-gradient-primary btn-sm">Diagnosa</a>
