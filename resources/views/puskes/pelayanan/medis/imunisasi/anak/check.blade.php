                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <a href="/pelayanan/medis/proses/{{$data->id}}/anak/imunisasi/imun_anak" class="btn btn-success shadow">IMUNISASI ANAK </a>
                                <a href="/pelayanan/medis/proses/{{$data->id}}/anak/imunisasi/imun_dewasa" class="btn btn-primary shadow">IMUNISASI DEWASA </a>
                            </div>
                        </div> 
                      </div>
                    </div>
