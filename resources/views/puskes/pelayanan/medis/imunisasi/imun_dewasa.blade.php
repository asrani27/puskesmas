                          ...
                          @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" value="{{\Carbon\Carbon::now()->format('d M Y h:i:s')}}" readonly>
                                    </div>
                                </div>
                                <div class="input-group row">
                                    <label class="col-sm-3 col-form-label text-right"><small>Umur</small></label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control form-control-sm" id="datepicker" value="{{umurBulan($data->pendaftaran->pasien->tanggal_lahir)}}" readonly>
                                    </div>
                                </div>
                                </div>
                            </div>
