                        ...
                        <div class="row">
                          <div class="col-md-6">
                              ...
                              <div class="input-group row">
                                  ...
                                  <div class="col-sm-9">
                                      <input type="radio" name="macam_persalinan"> Normal <br />
                                      <input type="radio" name="macam_persalinan"> Kelainan Letak <br />
                                      <input type="radio" name="macam_persalinan"> CPD <br />
                                      <input type="radio" name="macam_persalinan"> Cacat Bawaan<br />
                                      <input type="radio" name="macam_persalinan"> Caesar <br />
                                  </div>
                              </div>
                              <div class="input-group row">
                                  <label class="col-sm-3 col-form-label text-right"><small>Pelayanan Persalinan</small></label>
                                  <div class="col-sm-9">
                                      <input type="radio" name="pelayanan_persalinan"> Dokter <br />
                                      <input type="radio" name="pelayanan_persalinan"> Bidan <br />
                                      <input type="radio" name="pelayanan_persalinan"> Tenaga Medis <br />
                                      <input type="radio" name="pelayanan_persalinan"> Dukun Terlatih<br />
                                      <input type="radio" name="pelayanan_persalinan"> Tenaga Tak Terlatih<br />
                                  </div>
                              </div>
                              </div>
                          </div>
                          <div class="col-md-6">
                              ...
                              <div class="input-group row">
                                  ...
                                  <div class="col-sm-9">
                                      <input type="radio" name="tempat_persalinan"> Rumah <br />
                                      <input type="radio" name="tempat_persalinan"> Rumah Sakit <br />
                                      <input type="radio" name="tempat_persalinan"> Puskesmas <br />
                                      <input type="radio" name="tempat_persalinan"> R. Bersalin<br />
                                      <input type="radio" name="tempat_persalinan"> R. Bidan<br />
                                      <input type="radio" name="tempat_persalinan"> Klinik<br />
                                  </div>
                              </div>
                              <div class="input-group row">
                              ...
                              <div class="input-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="radio" name="asi"> ASI<br />
                                    <input type="radio" name="asi"> Bukan ASI<br />
                                  </div>
                              </div>
                              <div class="input-group row">
                                  <label class="col-sm-3 col-form-label text-right"><small>VIT A 6 Bulan ?</small></label>
                                  <div class="col-sm-9">
                                    <input type="radio" name="vita"> Ya<br />
                                    <input type="radio" name="vita"> Tidak<br />
                                  </div>
                              </div>
                              </div>
                          </div>   
