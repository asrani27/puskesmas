        ...
        <div class="card">
                  ...
                  <table class="table table-sm" style="font-size:13px;">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$data->pendaftaran->pasien->tempat_lahir}}, {{$data->pendaftaran->pasien->tanggal_lahir}}
                        </td>
                      </tr>
                      <tr>
                ...
                <table class="table table-sm table-bordered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$data->tempat_lahir}} / {{$data->tanggal_lahir == null ? null :
          ...
          <div class="card-footer">
            <div class="text-right">
              {{-- <a href="/pendaftaran/pasien/edit/" class="btn btn-sm btn-info shadow"><i class="fas fa-print"></i>
                Cetak Pengantar Rujukan</a>
              <a href="/pendaftaran/pasien/delete/" class="btn btn-sm btn-info shadow"
                onclick="return confirm('Yakin Menghapus Semua Data Tentang Pasien Ini?');"><i class="fas fa-trash"></i>
                Cetak</a> --}}
            </div>
          </div>
          <!-- /.card-body -->
