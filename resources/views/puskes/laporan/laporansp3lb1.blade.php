...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group row">
                        <label class="col-sm-3 col-form-label text-right"><small>Dari</small></label>
                        <div class="col-sm-9"> 
                            <select class="form-control form-control-sm" name="bulandari">
                    ...
                    <div class="input-group row">
                        <label class="col-sm-3 col-form-label text-right"><small>Sampai</small></label>
                        <div class="col-sm-9"> 
                            <select class="form-control form-control-sm" name="bulansampai">
                            <option value="">-Pilih-</option>
                            <option value="01" {{$bulan == '01' ? 'selected' : ''}}>Januari</option>
                            <option value="02" {{$bulan == '02' ? 'selected' : ''}}>Februari</option>
                            <option value="03" {{$bulan == '03' ? 'selected' : ''}}>Maret</option>
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            <select class="form-control form-control-sm" name="tahundari">
                            <option value="">-Pilih-</option>
                    ...
                    <div class="input-group row">
                        <label class="col-sm-3 col-form-label text-right"><small>Tahun</small></label>
                        <div class="col-sm-9"> 
                            <select class="form-control form-control-sm" name="tahunsampai">
                            <option value="">-Pilih-</option>
                            <option value="2020" {{$tahun == '2020' ? 'selected' : ''}}>2020</option>
                            <option value="2019" {{$tahun == '2019' ? 'selected' : ''}}>2019</option>
                            <option value="2018" {{$tahun == '2018' ? 'selected' : ''}}>2019</option>
            ...
            <hr>
                <center><b>LAPORAN HARIAN - SP3 LB1</b></center>
              ...
              <table id="example" class="table table-bordered table-sm">
                ...
                <tr class="bg-gradient-primary" style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold">
                  ...
                  <th rowspan=4>Kode ICD-10</th>
                  <th rowspan=4>Jenis Penyakit</th>
                  <th colspan=58>Jumlah Penderita</th>
                </tr>
                <tr class="bg-gradient-primary" style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold">
                  <th colspan=4>0-7Hr</th>
                  <th colspan=4>8-28Hr</th>
                  <th colspan=4>29hr-1Th</th>
                  ...
                  <th colspan=4>60-64Th</th>
                  <th colspan=4>65-69Th</th>
