            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9">
                        <input type="text" id="datepicker" class="form-control form-control-sm"  name="dari" required value="{{\Carbon\Carbon::parse($start)->format('d-m-Y')}}">
                        </div>
                    </div>
                    <div class="input-group row">
                        <label class="col-sm-3 col-form-label text-right"><small>Sampai <span class="text-danger"><strong>*</strong></span></small></label>
                        <div class="col-sm-9">
                            <input type="text" id="datepicker2" class="form-control form-control-sm"  name="sampai" required value="{{\Carbon\Carbon::parse($end)->format('d-m-Y')}}">
                        </div>
                    </div>
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            ...
                            <option value="semua" {{$jenis_laporan == 'semua' ? 'selected' : ''}}>Semua</option>
                            <option value="kunjungan" {{$jenis_laporan == 'kunjungan' ? 'selected' : ''}}>Kunjungan</option>
                            <option value="pasien" {{$jenis_laporan == 'pasien' ? 'selected' : ''}}>Pasien</option>
                        </select>
                        </div>
                    </div> 
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            ...
                            <option value="semua" {{$kunjungan == 'semua' ? 'selected' : ''}}>Semua</option>
                            <option value="sakit" {{$kunjungan == 'sakit' ? 'selected' : ''}}>Sakit</option>
                            <option value="sehat" {{$kunjungan == 'sehat' ? 'selected' : ''}}>Sehat</option>
                        </select>
                        </div>
                    </div> 
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            ...
                            <option value="semua" {{$jenis_kunjungan == 'semua' ? 'selected' : ''}}>Semua</option>
                            <option value="baru" {{$jenis_kunjungan == 'baru' ? 'selected' : ''}}>Baru</option>
                            <option value="lama" {{$jenis_kunjungan == 'lama' ? 'selected' : ''}}>Lama</option>
                        </select>
                        </div>
                    </div> 
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            ...
                            <option value="semua" {{$jenis_kelamin == 'semua' ? 'selected' : ''}}>Semua</option>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            ...
                            <option value="semua" {{$asuransi == 'semua' ? 'selected' : ''}}>Semua</option>
                            <option value="0000" {{$asuransi == '0000' ? 'selected' : ''}}>Umum</option>
                            <option value="0001" {{$asuransi == '0001' ? 'selected' : ''}}>BPJS</option>
                        </select>
                        </div>
                    </div> 
                    <div class="input-group row">
                        ...
                        <div class="col-sm-9"> 
                            ...
                            <option value="semua" {{$wilayah == 'semua' ? 'selected' : ''}}>Semua</option>
                            <option value="dalam_kota" {{$wilayah == 'dalam_kota' ? 'selected' : ''}}>Dalam Kota</option>
                            <option value="luar_kota" {{$wilayah == 'luar_kota' ? 'selected' : ''}}>Luar Kota</option>
                        </select>
                        </div>
                    </div> 
                    </div>
