...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form action="{{route('simpanStokobat')}}" method="POST">
                @csrf  
                <div class="card-body p-2 table-responsive">
                    <div class="input-group row">
                        ...
                        <div class="col-sm-2">
                            <a href="/pengaturan/data_master/obat/add" class="btn btn-primary"><i class="fas fa-plus"></i> Obat Baru</a>
                        </div>
                    </div>
                    <div class="input-group row">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-8">
                        <div class="form-group">
                            <input type="text" class="form-control" name="harga_jual" value="0" required>
                    ...
                    <div class="input-group row">
                        ...
                        <div class="col-sm-8">
                        <div class="form-group">
                            <input type="text" class="form-control" name="jumlah_stok" value="0" required>
